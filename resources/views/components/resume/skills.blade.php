...
<section class="resume-skills resume-section mb-8">
    <h2 class="text-2xl font-heading text-secondary mb-4">Technical Skills</h2>

    @if(isset($skills['top']) && count($skills['top']) > 0)
        <div class="mb-4">
            @foreach($skills['top'] as $category)
                <div class="skill-category mb-3">
                    <h3 class="text-lg font-medium text-primary mb-1">{!! $category['title'] !!}</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="skill-category">
            <h3 class="text-base font-medium text-primary mb-1">{!! $category['title'] !!}</h3>
