...
@section('main')
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <form method="POST" action="{{ route('admin.ai.systems.store') }}">
            @csrf

            @include('admin.ai.systems._form')
