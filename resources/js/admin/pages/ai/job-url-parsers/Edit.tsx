                ...
                <CardContent>
                    <Box component="form" onSubmit={handleSubmit}>
                        ...
                        <TextField
                            ...
                            error={Boolean(
                                form.errors.job_description_selector,
                            )}
                        ...
                        <TextField
                            ...
                            onChange={(e) => {
                                form.setData("ai_reasoning", e.target.value);
                            }}
                        ...
                        <TextField
                            ...
                            onChange={(e) => {
                                form.setData("html", e.target.value);
                            }}
                        ...
                        {previewResult && (
                            <Card variant="outlined" sx={{ mb: 3 }}>
                                <CardContent>
                                    ...
                                    {Object.keys(previewFieldErrors).length >
                                        0 && (
                                        <Alert
                                            severity="warning"
                                            sx={{ mb: 2 }}
                                        >
                                            One or more selectors failed. Review
                                            selector syntax below.
                                        </Alert>
                                    )}
